        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Edit flash sale</h3>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form action="{{ route('library.flash-sales.update', $flashSale->id) }}" method="POST"
                                        class="form">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="discount_type" id="discount_type"
                                                            required>
                                                            <option
                                                                {{ $flashSale->discount_type === \App\Enums\DiscountType::Fixed ? 'selected' : ' ' }}
                                                                value="{{ \App\Enums\DiscountType::Fixed->value }}">
                                                                Fixed amount</option>
                                                            <option
                                                                {{ $flashSale->discount_type === \App\Enums\DiscountType::Percentage ? 'selected' : ' ' }}
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="datetime-local"
                                                        value="{{ old('start_at', $flashSale->start_at) }}"
                                                        class="form-control" name="start_at" data-toggle="tooltip"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="datetime-local" value="{{ old('end_at', $flashSale->end_at) }}"
                                                        class="form-control" name="end_at" data-toggle="tooltip"
                                                        data-trigger="hover" data-placement="top" required>
                                                    @error('end_at')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                ...
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <input name="applies_to_all_books" type="checkbox"
                                                            ...
                                                            value="1"
                                                            {{ old('applies_to_all_books', $flashSale->applies_to_all_books) ? 'checked' : '' }}>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @php
                                                            $selectedCategories = old(
                                                                'categories',
                                                                $flashSale->categories()->pluck('category_id')->toArray(),
                                                            );
                                                        @endphp
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        @php
                                                            $selectedBooks = old(
                                                                'books',
                                                                $flashSale->books()->pluck('book_id')->toArray(),
                                                            );
                                                        @endphp
