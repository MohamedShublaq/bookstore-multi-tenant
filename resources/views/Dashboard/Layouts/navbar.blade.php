                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1">Hello,
                                <span class="user-name text-bold-700">
                                    {{ auth('admin')->user()->name ?? (auth('library-admin')->user()->name ?? 'Guest') }}
                                </span>
                            </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{auth()->guard('admin')->check() ? route('dashboard.showChangePassword') : route('library.showChangePassword')}}"><i class="la la-key"></i>
                                Change password</a>
                            <a class="dropdown-item" href="javascript:void(0)"
                                onclick="document.getElementById('logoutForm').submit();"><i class="ft-power"></i>
                                Logout</a>
