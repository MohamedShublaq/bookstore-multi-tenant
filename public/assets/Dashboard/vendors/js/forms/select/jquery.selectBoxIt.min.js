  ...
  a.widget("selectBox.selectBoxIt", {
    ...
    _create: function (b) {
      ...
      if (d.element.is("select"))
        return (
          (d.widgetProto = a.Widget.prototype),
          ...
          (d.theme = a.isPlainObject(f)
            ? a.extend({}, d.getThemes()["default"], f)
            : d.getThemes()[f]
            ? d.getThemes()[f]
            : d.getThemes()["default"]),
          (d.currentFocus = 0),
      ...
      return (
        ...
        (b.dropdown = a("<span/>", {
          ...
          class:
            ...
            ("button" === f ? g : "") +
            " " +
            (b.selectBox.prop("disabled") ? b.theme.disabled : b.theme.enabled),
          name: e,
          tabindex: b.selectBox.attr("tabindex") || "0",
          unselectable: "on",
        })
          .append(b.dropdownImageContainer.append(b.dropdownImage))
          .append(b.dropdownText)),
    ...
    _createUnorderedList: function () {
      ...
      if (
        (o.options.showFirstOption ||
          (o.selectItems.first().attr("disabled", "disabled"),
        ...
        o.selectItems.each(function (q) {
          (m = a(this)),
            ...
            this.selected &&
              (o._setText(o.dropdownText, i || l), (o.currentFocus = q));
        }),
      ...
      return (
        ...
        o.list
          ...
          .not(".optgroupHeader")
          .addClass(o.theme.disabled),
        o.dropdownImage.addClass(
          o.selectBox.attr("data-icon") ||
            o.options.defaultIcon ||
            o.listItems.eq(o.currentFocus).find("i").attr("class")
        ),
        o.dropdownImage.attr(
          "style",
          o.listItems.eq(o.currentFocus).find("i").attr("style")
        ),
        o
      );
    },
    _replaceSelectBox: function () {
      ...
      return (
        f.selectBox.css("display", "none").after(f.dropdownContainer),
      ...
      return (
        "search" === a
          ? e > h - f
            ...
            : -1 > f && b.list.scrollTop(f - e)
          : "up" === a
          ? -1 > f && b.list.scrollTop(d - g)
          : "down" === a && e > h - f && b.list.scrollTop(d + (g - h + e)),
        b
      );
    },
    ...
    open: function (a) {
      var b = this,
        ...
        f = b.options["native"],
        g = b.isMobile;
      return !b.listItems.length || b.dropdown.hasClass(b.theme.disabled)
        ? b
        : (f ||
            g ||
            ...
            b._dynamicPositioning &&
              b.options.dynamicPositioning &&
              b._dynamicPositioning(),
            "none" === c
              ? b.list.show()
              : "show" === c || "slideDown" === c || "fadeIn" === c
              ? b.list[c](d)
              : b.list.show(c, e, d),
      ...
      return (
        this.dropdown.on({
          "click.selectBoxIt": function () {
            d.dropdown.trigger("focus", !0),
              d.originalElem.disabled ||
                (d.triggerEvent("click"), e || f || d.toggle());
          },
          ...
          "blur.selectBoxIt": function () {
            d.blur &&
              (d.triggerEvent("blur"), d.close(), a(this).removeClass(g));
          },
          "focus.selectBoxIt": function (b, c) {
            ...
            a(this).removeData("mdown"),
              ...
              c ||
                (a(this).hasClass(d.theme.disabled) || a(this).addClass(g),
        ...
        d.list.on(
          {
            ...
            "focusin.selectBoxIt": function () {
              ...
              ((d.options.searchWhenHidden && b) ||
                d.options.aggressiveChange ||
                (b && d.options.selectWhenHidden)) &&
                d._update(a(this)),
                a(this).addClass(g);
            },
            "mouseup.selectBoxIt": function () {
            ...
            "mouseenter.selectBoxIt": function () {
              "false" === a(this).attr("data-disabled") &&
                (d.listItems.removeAttr("data-active"),
        ...
        d.selectBox.on({
          "change.selectBoxIt, internal-change.selectBoxIt": function (a, e) {
            var f, g;
            e ||
              ((f = d.list.find('li[data-val="' + d.originalElem.value + '"]')),
              f.length &&
                (d.listItems.eq(d.currentFocus).removeClass(d.focusClass),
              ...
              f.find("i").attr("class") &&
                (d.dropdownImage
                  .attr("class", f.find("i").attr("class"))
          ...
          "open.selectBoxIt": function () {
            var a,
              b = d.list.find(
                "li[data-val='" + d.dropdownText.attr("data-val") + "']"
              );
            b.length || (b = d.listItems.not("[data-disabled=true]").first()),
              ...
              d.options.hideCurrent && (d.listItems.show(), a.hide());
          },
    ...
    _update: function (a) {
      ...
      "false" === a.attr("data-disabled") &&
        ((b = e.listItems.eq(e.currentFocus).attr("data-selectedtext")),
        (c = g.attr("data-text")),
        (d = c ? c : g.text()),
        (f && e.options.html
          ? e.dropdownText.html() === f
          : e.dropdownText.text() === f) &&
        e.selectBox.val() === a.attr("data-val")
          ? e.triggerEvent("change")
          : (e.selectBox.val(a.attr("data-val")),
            (e.currentFocus = +a.attr("data-id")),
            e.originalElem.value !== e.dropdownText.attr("data-val") &&
              e.triggerEvent("change")));
    },
    _addClasses: function (a) {
      ...
      return (
        (b.openClass = a.open),
        (b.selectedClass = "selectboxit-selected"),
        b.downArrow.addClass(
          b.selectBox.attr("data-downarrow") || b.options.downArrowIcon || e
        ),
    ...
    refresh: function (a, b) {
      var c = this;
      return (
        c._destroySelectBoxIt()._create(!0),
    ...
    triggerEvent: function (a) {
      var b = this,
        c = b.options.showFirstOption
          ? b.currentFocus
          : b.currentFocus - 1 >= 0
          ? b.currentFocus
          : 0;
      return (
        b.selectBox.trigger(a, {
  ...
  (e.add = function (b, c) {
    this._populate(b, function (b) {
      var d,
        ...
        k = j && f._parseJSON(b);
      if (
        (b && ("array" === g || (j && k.data && "array" === a.type(k.data)))) ||
        ("object" === g && b.data && "array" === a.type(b.data))
      ) {
        for (
          f._isJSON(b) && (b = k), b.data && (b = b.data), e = b.length;
          e - 1 >= h;
          h += 1
        )
          (d = b[h]),
            a.isPlainObject(d)
              ? i.push(a("<option/>", d))
              : "string" === a.type(d) &&
                i.push(a("<option/>", { text: d, value: d }));
    ...
    (e._ariaAccessibility = function () {
      ...
      return (
        ...
        b.dropdownText.attr({ "aria-live": "polite" }),
        b.dropdown.on({
          "disable.selectBoxIt": function () {
        ...
        b.list.attr({ role: "listbox", "aria-hidden": "true" }),
        b.listItems.attr({ role: "option" }),
        b.selectBox.on({
          "open.selectBoxIt": function () {
        ...
        b.length &&
          a.each(b, function (b, d) {
            var f = d.name.toLowerCase(),
              g = d.value;
            "null" === g ||
              (-1 === a.inArray(f, e) && -1 === f.indexOf("data")) ||
              c.attr(f, g);
          }),
        d
      );
    ...
    (e._destroySelectBoxIt = function () {
      var b = this;
      return (
        b.dropdown.off(".selectBoxIt"),
        a.contains(b.dropdownContainer[0], b.originalElem) &&
          b.dropdownContainer.before(b.selectBox),
    ...
    (e.disable = function (a) {
      ...
      return (
        b.options.disabled ||
          ...
          b.dropdown
            .removeAttr("tabindex")
            .removeClass(b.theme.enabled)
            .addClass(b.theme.disabled),
          b.setOption("disabled", !0),
    ...
    (e._dynamicPositioning = function () {
      ...
      if ("number" === a.type(b.listSize))
        ...
        var c = b.dropdown.offset().top,
          ...
          j = !i;
        if (
          (b.list.data("max-height") ||
            b.list.data("max-height", b.list.outerHeight()),
          j)
        )
          if (b.dropdown.offset().top - h >= d)
            b.list.css("max-height", d),
              b.list.css(
                "top",
                b.dropdown.position().top - b.list.outerHeight()
              );
          else {
            var k = Math.abs(c + e + d - (g + h)),
              l = Math.abs(b.dropdown.offset().top - h - d);
            l > k
              ? (b.list.css("max-height", d - k - e / 2),
                b.list.css("top", "auto"))
              : (b.list.css("max-height", d - l - e / 2),
                b.list.css(
                  "top",
                  b.dropdown.position().top - b.list.outerHeight()
                ));
    ...
    (e.enable = function (a) {
      ...
      return (
        b.options.disabled &&
          (b.triggerEvent("enable"),
          b.selectBox.removeAttr("disabled"),
          b.dropdown
            .attr("tabindex", 0)
            .removeClass(b.theme.disabled)
            .addClass(b.theme.enabled),
          b.setOption("disabled", !1),
          b._callbackSupport(a)),
        b
      );
    }),
    (e.enableOption = function (b, c) {
      ...
      return (
        "number" === f &&
          ((d = e.selectBox.find("option").eq(b)),
          e.triggerEvent("enable-option"),
          d.removeAttr("disabled"),
          e.listItems
            .eq(b)
            .attr("data-disabled", "false")
            .removeClass(e.theme.disabled)),
    ...
    (e.moveDown = function (a) {
      ...
      b.currentFocus += 1;
      var c =
          "true" === b.listItems.eq(b.currentFocus).attr("data-disabled")
            ? !0
            : !1,
        d = b.listItems
          .eq(b.currentFocus)
      ...
      if (b.currentFocus === b.listItems.length) b.currentFocus -= 1;
        ...
        if (c && d)
          return (
            b.listItems.eq(b.currentFocus - 1).blur(), b.moveDown(), void 0
          );
        c && !d
          ? (b.currentFocus -= 1)
          : (b.listItems
    ...
    (e._setCurrentSearchOption = function (a) {
      var b = this;
      return (
        (b.options.aggressiveChange ||
          b.options.selectWhenHidden ||
          b.listItems.eq(a).is(":visible")) &&
          b.listItems.eq(a).data("disabled") !== !0 &&
          (b.listItems.eq(b.currentFocus).blur(),
          (b.currentIndex = a),
          (b.currentFocus = a),
    ...
    (e._searchAlgorithm = function (a, b) {
      ...
      for (c = a, e = i.length; e > c; c += 1) {
        ...
        if (
          (h ||
            ((g.currentText = g.currentText
              .charAt(g.currentText.length - 1)
              .replace(/[|()\[{.+*?$\\]/g, "\\$0")),
            (j = g.currentText)),
          (b = new RegExp(j, "gi")),
          j.length < 3)
          ...
          if (
            ((b = new RegExp(j.charAt(0), "gi")), -1 !== f.charAt(0).search(b))
          )
            return (
              g._setCurrentSearchOption(c),
              (f.substring(0, j.length).toLowerCase() !== j.toLowerCase() ||
                g.options.similarSearch) &&
                (g.currentIndex += 1),
              !1
            );
    ...
    (e.search = function (a, b, c) {
      var d = this;
      c
        ? (d.currentText += a.replace(/[|()\[{.+*?$\\]/g, "\\$0"))
        : (d.currentText = a.replace(/[|()\[{.+*?$\\]/g, "\\$0"));
      var e = d._searchAlgorithm(
        d.currentIndex,
        new RegExp(d.currentText, "gi")
      );
      return (
        e && d._searchAlgorithm(0, d.currentText), d._callbackSupport(b), d
      );
    }),
      ...
      a.selectBox.on({
        ...
        "mousedown.selectBoxIt": function () {
          a.hasChanged ||
            ...
            (a._updateMobileText(), a.triggerEvent("option-click"));
        },
        "enable.selectBoxIt": function () {
    ...
    (e.remove = function (b, c) {
      ...
      if ("array" === g) {
        ...
        "number" === g
          ? f.selectBox.find("option").eq(b).remove()
          : f.selectBox.find("option").remove();
      return (
        f.dropdown
          ? f.refresh(function () {
              f._callbackSupport(c);
    ...
    (e.selectOption = function (b, c) {
      ...
      return (
        "number" === e
          ? d.selectBox.val(d.selectItems.eq(b).val()).change()
          : "string" === e && d.selectBox.val(b).change(),
    ...
    (e.setOptions = function (b, c) {
      var d = this;
      return (
        a.isPlainObject(b) && (d.options = a.extend({}, d.options, b)),
        d.refresh(function () {
          d._callbackSupport(c);
        }, !0),
        d
